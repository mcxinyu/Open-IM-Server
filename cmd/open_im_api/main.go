...
func main() {
	...
	userRouterGroup := r.Group("/user")
	{
		...
		userRouterGroup.POST("/get_encryption_key", user.GetEncryptionKey)
		userRouterGroup.POST("/get_all_joined_group_encryption_key", user.GetAllJoinedGroupEncryptionKey)
	}
